...
public class Player {
     ...
     * @param fighters An arraylist of fighters
     * @param branch The player's branch
     * @param team The player's team
     */
    public Player(
            String name,
            ArrayList<Student> fighters,
            Branch branch,
            Team team
    ) {
        this.name = name;
        this.fighters = fighters;
        this.reservists = new ArrayList<>();
        this.branch = branch;
        this.points = 400;
        this.team = team;
    }
    ...
    public String toString() {
        return "Player{" +
                "points=" + points +
                ", name='" + name + '\'' +
                ", fighters=" + Arrays.toString(fighters.toArray()) +
                ", reservists=" + Arrays.toString(reservists.toArray()) +
                ", branch=" + branch +
                '}';
    }
}
