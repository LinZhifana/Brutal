...
public class distributerPointsP1 {
...
>>>>>>> Stashed changes
	...
	public static void distributer() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					distributerPointsP1 window = new distributerPointsP1();
	...
	private void initialize() {
		frame = new JFrame("C'est du brutal! "+personnalisation.getNameP1()+"-Veuillez entrer le nom avant de décider quel rôle il est");
...
<<<<<<< Updated upstream
	...
	private void checkOver() {
		if(distributerPointsP1.fightersBibli.size()+distributerPointsP1.fightersAdmin.size()+
				...
				distributerPointsP1.fightersSportive.size()+distributerPointsP1.reservists.size()>19) {
=======
	//==================================>19 original
	private void checkOver() {
		if(distributerPointsP1.fightersBibli.size()+distributerPointsP1.fightersAdmin.size()+
...
>>>>>>> Stashed changes
			distributerPointsP2.distributer();
			frame.dispose();
		}
	}
